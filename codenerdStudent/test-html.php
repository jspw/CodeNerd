...
<body>
    ...
    <div id="main">
        ...
        <div class="well" id="afterCompiler">
        ...
        <script>
            ...
            // 					if (data) {
            //                         //split data
            //                         var data = value.split("fuckx");

            //                         $("#beforeCompiler").val(data[0]);
            //                     //    $("#afterCompiler").html(data[1]);
            //                         $("#beforecompiler").val(data[1]); //this is the code section
            // 						//              window.alert(data);
            // 					}
            // 				},
            // 				error: function() {
